 ...
 */
final class Version20180920201902 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A2A8C0539777D11E ON statements (category_id_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_A2A8C0539777D11E ON statements');
